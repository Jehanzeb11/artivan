...
<Image src={person1} width={1000} height={1000} alt="person-1" className="sm:w-20 w-14 absolute -top-5 p-0 right-[40%]" data-aos="fade-in" data-aos-delay="50" data-aos-duration="1000"  data-aos-easing="ease-in-out" />
<Image src={person2} width={1000} height={1000} alt="person-2" className="sm:w-20 w-14 absolute -bottom-5 p-0 left-[14%]" data-aos="fade-out" data-aos-delay="50" data-aos-duration="1000"  data-aos-easing="ease-in-out"/>
<Image src={person3} width={1000} height={1000} alt="person-3" className="sm:w-20 w-14 absolute bottom-0 p-0 right-[14%]" data-aos="fade-in" data-aos-delay="50" data-aos-duration="1000"  data-aos-easing="ease-in-out"/>
