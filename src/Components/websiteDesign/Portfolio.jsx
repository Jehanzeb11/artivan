...
const Portfolio = () => {
  return (
    <div className='w-full flex justify-center items-center lg:py-16 py-8 px-4'>
        ...
        <h1 className='lg:text-6xl sm:text-4xl text-3xl font-bold text-gray-800 text-center' style={{lineHeight: "1.4"}}>Creating Unique <span className='text-primary'>Website and Web App Designs</span> for Every Business</h1>
